...
class ShellEVClientBuilder
{
    ...
    /**
     * @see ShellEVClientBuilder::clientCredentialsAuthCredentials
     *
    ...
    public function build(): ShellEVClient
    {
        return new ShellEVClient($this->config);
    }
}
